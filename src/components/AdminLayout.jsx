...
export default function AdminLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-[var(--accent)]/10 via-white to-[var(--brand)]/10">
      ...
      >
        <h2 className="text-2xl font-extrabold rounded-lg shadow text-transparent bg-gradient-to-r from-[var(--accent)] to-[var(--brand)] bg-clip-text hover:opacity-90 transition p-2 text-center">
          ⚡ Admin Panel
        </h2>
